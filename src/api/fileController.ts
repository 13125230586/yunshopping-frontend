...
/** deleteFileByUrlOss POST /api/file/oss/deleteByUrl */
export async function deleteFileByUrlOssUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.deleteFileByUrlOssUsingPOSTParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/file/oss/deleteByUrl', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** uploadPictureOss POST /api/file/oss/upload */
export async function uploadPictureOssUsingPost(
  body: {},
  file?: File,
  options?: { [key: string]: any }
) {
  ...
  return request<API.BaseResponseUploadPictureResult_>('/api/file/oss/upload', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
...
/** uploadAvatarOss POST /api/file/oss/upload/avatar */
export async function uploadAvatarOssUsingPost(
  body: {},
  file?: File,
  options?: { [key: string]: any }
) {
  ...
  return request<API.BaseResponseUploadPictureResult_>('/api/file/oss/upload/avatar', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
...
/** uploadProductPictureOss POST /api/file/oss/upload/product */
export async function uploadProductPictureOssUsingPost(
  body: {},
  file?: File,
  options?: { [key: string]: any }
) {
  ...
  return request<API.BaseResponseUploadPictureResult_>('/api/file/oss/upload/product', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
...
/** uploadShopPictureOss POST /api/file/oss/upload/shop */
export async function uploadShopPictureOssUsingPost(
  body: {},
  file?: File,
  options?: { [key: string]: any }
) {
  ...
  return request<API.BaseResponseUploadPictureResult_>('/api/file/oss/upload/shop', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
